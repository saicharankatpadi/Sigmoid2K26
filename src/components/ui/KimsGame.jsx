...
const eventData = {
  event_info: {
    ...
    features: [
      ...
      { id: "03", content: "Think & Spell Puzzles" },
      { id: "04", content: "Epic Treasure Hunt" },
      { id: "05", content: "Team Coordination" },
      { id: "06", content: "Time-based Sorting" }
    ]
  },
  video_preview: {
    video_src: "https://res.cloudinary.com/djiivo0r7/video/upload/v1773379518/WhatsApp_Video_2026-03-12_at_22.17.43_lnwqdv.mp4",
    badges: [
      { position: "top-left", icon: "user", text: "Memory Challenge" },
      { position: "top-right", icon: "diamond", text: "Visual Identification" },
      { position: "bottom-left", icon: "users", text: "Puzzle Solving" },
      { position: "bottom-right", icon: "academic", text: "Fastest Response" }
    ]
  },
  mission: [
    {
      id: "round1",
      icon: "target",
      title: "1st ROUND: RECOGNIZING OBJECTS",
      points: [
        "DATE: April 3rd | Team of 3 Members",
        "A tray of objects is displayed for 10 to 15 seconds, then certain items are removed.",
        "Teams must identify the missing objects—the first to sound the buzzer answers.",
        "Points are awarded for correct guesses; top teams qualify for the next round."
      ]
    },
    {
      id: "round2",
      icon: "rocket",
      title: "2nd ROUND: THINK AND SPELL",
      points: [
        "Section I: Fill-in-the-blank format with missing letters. 30 seconds per word.",
        "Section II: Three image clues provided for each hidden word.",
        "Guess the answer first via buzzer or paper to score points.",
        "High-performing teams will promote to the final Treasure Hunt round."
      ]
    },
    {
      id: "round3",
      icon: "cube",
      title: "3rd ROUND: TREASURE HUNT",
      points: [
        "The final showdown! Duration ranges from 30 to 45 minutes.",
        "Sequential hints: Solve the first question to unlock the next location.",
        "The team that completes all clues the fastest will be declared the winner.",
        "A true test of team collaboration, logic, and speed across the campus."
      ]
    }
  ],
  learnings: {
    ...
    items: [
      "Logic", "Observation", "Creativity", "Teamwork",
      "Coordination", "Memory", "Speed", "Deduction",
      "Quick Reflexes", "Spontaneity", "Critical Thinking", "Focus"
    ],
    button_text: "And much more...",
    description: [
      "Sharpen your short-term memory through rapid object recognition challenges.",
      "Test your vocabulary and lateral thinking in the 'Think and Spell' segments.",
      "Navigate complex clues and campus terrain in a high-stakes treasure hunt.",
      "Strengthen peer-to-peer communication and synergy under competitive pressure.",
      "Experience a fun-filled multi-round format curated by organizers for maximum engagement."
    ]
  },
  perks: {
    ...
    items: [
      ...
      { text: "Winner Recognition", icon: "diamond", color: "#a855f7" },
      { text: "Exciting Gift Hampers", icon: "globe", color: "#f89b29" },
      { text: "Skill Certification", icon: "document", color: "#2dd4bf" },
      { text: "Campus Recognition", icon: "users", color: "#10B981" },
      { text: "Networking with Peers", icon: "briefcase", color: "#6366f1" }
    ]
  },
  mentors: [
    {
  ...
  faqs: [
    { id: "q1", question: "What is the team size?", answer: "Each team must consist of 3 members." },
...
const FaqItem = ({ q, a }) => {
  ...
  return (
    <div className="border border-[#222] hover:border-[#333] bg-[#0c0a09] rounded-xl mb-3 overflow-hidden transition-colors">
      ...
      {open && (
        <div className="px-5 pb-5 pt-0 text-white/60 text-[14px] font-normal leading-relaxed">
          {a}
        </div>
      )}
    </div>
...
export const KimsGameEventPage = () => {
              ...
              <ul className="space-y-3.5">
                {m.points.map((pt, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="text-[14px] text-white/60 leading-relaxed font-normal">{pt}</span>
                  </li>
                ))}
              </ul>
            </div>
...
export default KimsGameEventPage;
